    ...
    public class DataInitializer
    {
        ...
        public async Task InitializeData()
        {
            ...
            if(_dbContext.Database.EnsureCreated())
            {
                ...
                #region Product
                Product product1 = new Product("Cola 33cl", "ms-appx:///Assets/colaBlik.png", 2.50,ProductCategory.Drinks, false);
                _dbContext.Products.Add(product1);
                Product product2 = new Product("Cola 50cl", "ms-appx:///Assets/colaFlesje.png", 3.50, ProductCategory.Drinks, false);
                _dbContext.Products.Add(product2);
                Product product3 = new Product("Ice tea 33cl", "ms-appx:///Assets/iceTeaBlik.png", 2.50, ProductCategory.Drinks, false);
                _dbContext.Products.Add(product3);
                Product product4 = new Product("Ice tea 50cl", "ms-appx:///Assets/iceTeaFlesje.png", 3.50, ProductCategory.Drinks, false);
                _dbContext.Products.Add(product4);
                Product product5 = new Product("Fanta 33cl", "ms-appx:///Assets/fantaBlik.jpg", 2.50, ProductCategory.Drinks, false);
                _dbContext.Products.Add(product5);
                Product product6 = new Product("Fanta 50cl", "ms-appx:///Assets/fantaFlesje.jpg", 3.50, ProductCategory.Drinks, false);
                _dbContext.Products.Add(product6);
                Product product7 = new Product("Water 50cl", "ms-appx:///Assets/waterFlesje.jpg", 3.00, ProductCategory.Drinks, false);
                _dbContext.Products.Add(product7);
                Product product8 = new Product("Sparkling water 50cl", "ms-appx:///Assets/bruisWaterFlesje.png", 3.00, ProductCategory.Drinks, false);
                _dbContext.Products.Add(product8);
                Product product9 = new Product("Sprite 33cl", "ms-appx:///Assets/sprite.png", 3.00, ProductCategory.Drinks, false);
                _dbContext.Products.Add(product9);

                Product product11 = new Product("Pizza margarita", "ms-appx:///Assets/pizzaIcon.jpg", 5.00, ProductCategory.Food, false);
                _dbContext.Products.Add(product11);
                Product product42 = new Product("Pizza bolognaise", "ms-appx:///Assets/pizzaIcon.jpg", 6.00, ProductCategory.Food, false);
                _dbContext.Products.Add(product42);
                Product product43 = new Product("Pizza cheese", "ms-appx:///Assets/pizzaIcon.jpg", 6.00, ProductCategory.Food, false);
                _dbContext.Products.Add(product43);
                Product product44 = new Product("Pizza special", "ms-appx:///Assets/pizzaIcon.jpg", 7.00, ProductCategory.Food, false);
                _dbContext.Products.Add(product44);
                Product product455 = new Product("Pizza seafood", "ms-appx:///Assets/pizzaIcon.jpg", 7.00, ProductCategory.Food, false);
                _dbContext.Products.Add(product455);

                Product product57 = new Product("Horloge", "ms-appx:///Assets/watch.jpg", 50.00, ProductCategory.Gifts, false);
                _dbContext.Products.Add(product57);

                Product product58 = new Product("Pillow", "ms-appx:///Assets/pillow.jpg", 20.00, ProductCategory.Gifts, false);
                _dbContext.Products.Add(product58);

                Product product59 = new Product("The Book Of Wisdom", "ms-appx:///Assets/book.jpg", 32.00, ProductCategory.Gifts, false);
